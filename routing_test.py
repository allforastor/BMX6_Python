...
from nodes import local_node, router_node, iid_repos, neigh_node, ogm_aggreg_node
...
#                                                    C
#-----------------------------------------------------------------------------------------------------------------
# ver 6.17.2022 - included ogm frame sqn number testing from ogm aggreg node
#

# creation of msgs and frame    # modified
msg1 = OGM_ADV_msg(0, 0, None, 1)
msg2 = OGM_ADV_msg(0, 0, None, 2)
msg3 = OGM_ADV_msg(0, 0, None, 3)
ogmframe1 = OGM_ADV(header(" ", " ", " ", " "), -1, " ", [" "], [msg1, msg2, msg3])  # whitespaces are placeholder values
...
ogmframe2 = OGM_ADV(header(" ", " ", " ", " "), -1, " ", [" "], [])
nodeA_ogm_aggreg = ogm_aggreg_node([ogmframe1, ogmframe2], [], 0, 0)
nodeA_ogm_aggreg.set_aggr_sqn_no_ogm()  # set aggregated sqqn no for each frame
#print(ogmframe1)
#print(ogmframe2)

ogmframe3 = OGM_ADV(header(" ", " ", " ", " "), -1, " ", [" "], [])
nodeA_ogm_aggreg.ogm_advs.append(ogmframe3)
nodeA_ogm_aggreg.set_aggr_sqn_no_ogm()
#print(ogmframe3)
nodeA_ogm_aggreg.ogm_advs.remove(ogmframe1)
nodeA_ogm_aggreg.set_aggr_sqn_no_ogm()
